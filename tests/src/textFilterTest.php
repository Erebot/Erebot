...
extends PHPUnit_Framework_TestCase
{
    ...
    {
        new ErebotTextFilter(ErebotTextFilter::TYPE_STATIC, NULL);
    }
    ...
    {
        new ErebotTextFilter(ErebotTextFilter::TYPE_WILDCARD, NULL);
    }
    ...
    {
        new ErebotTextFilter(ErebotTextFilter::TYPE_REGEXP, NULL);
    }
...
extends PHPUnit_Framework_TestCase
{
    ...
    protected function validate($prefix_mode, $with_prefix, $without_prefix)
    {
        ...
        $prefixes   = $filter->getRecognizedPrefixes();
        $connection = new ErebotStubbedConnection();
        foreach ($prefixes as $prefix) {
            $event  =   new ErebotEvent(
                            $connection, 'foo', 'bar',
                            ErebotEvent::ON_TEXT,
