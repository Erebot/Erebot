 ...
 * for building additional modules for Erebot.
 */
abstract class ErebotModuleBase
{
    ...
    final public function __construct(iErebotConnection &$connection, $channel)
    {
        ...
        $this->translator   =   $mainCfg->getTranslator($this->moduleName);
        unset($config, $mainCfg);
     ...
     * This method should be considered to be part of the internal API
    ...
    /**
     * Registers the given callback as the help method
     * for this module.
     * All help requests directed to this module will be
     * passed to this method which may choose to handle it
     * (eg. by sending help messages to requester).
     * This method may also choose to ignore a given request,
     * which will result in a default "No help" response.
     *
     * \param $callback
