...
ErebotUtils::incl('mainConfig.php');
...
interface iErebotTextFilter
{
     ...
     *      \code
     *      $filter = new ErebotTextFilter($mainConfig, ErebotTextFilter::TYPE_STATIC, 'foo');
     *      \endcode
     *      and
     *      \code
     ...
     *      \endcode
     */
    public function __construct(iErebotMainConfig &$config, $type = NULL, $pattern = NULL, $require_prefix = FALSE);
