 ...
 */
class IrcdRatbox extends \Erebot\NumericProfile\Base
{
    ...
    /// \copydoc Erebot::Interfaces::Numerics::RPL_WHOISLOGGEDIN
    ...
    /// \copydoc Erebot::Interfaces::Numerics::ERR_BANNEDNICK
    const ERR_BANNEDNICK                = 485;
    ...
    /// \copydoc Erebot::Interfaces::Numerics::ERR_TARGCHANGE
    const ERR_TARGCHANGE                = 707;
    ...
    /// \copydoc Erebot::Interfaces::Numerics::ERR_TARGUMODEG
    const ERR_TARGUMODEG                = 716;
    ...
    /// \copydoc Erebot::Interfaces::Numerics::RPL_TESTMASKGECOS
    const RPL_TESTMASKGECOS             = 727;

    /// \copydoc Erebot::Interfaces::Numerics::RPL_MONONLINE
    const RPL_MONONLINE                 = 730;

    /// \copydoc Erebot::Interfaces::Numerics::RPL_MONOFFLINE
    const RPL_MONOFFLINE                = 731;

    /// \copydoc Erebot::Interfaces::Numerics::RPL_MONLIST
    const RPL_MONLIST                   = 732;

    /// \copydoc Erebot::Interfaces::Numerics::RPL_ENDOFMONLIST
    const RPL_ENDOFMONLIST              = 733;

    /// \copydoc Erebot::Interfaces::Numerics::ERR_MONLISTFULL
    const ERR_MONLISTFULL               = 734;

    /// \copydoc Erebot::Interfaces::Numerics::RPL_RSACHALLENGE2
    const RPL_RSACHALLENGE2             = 740;

    /// \copydoc Erebot::Interfaces::Numerics::RPL_ENDOFRSACHALLENGE2
    const RPL_ENDOFRSACHALLENGE2        = 741;
