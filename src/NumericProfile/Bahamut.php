 ...
 */
class Bahamut extends \Erebot\NumericProfile\Base
{
    ...
    /// \copydoc Erebot::Interfaces::Numerics::RPL_STATSCLONE
    ...
    /// \copydoc Erebot::Interfaces::Numerics::RPL_WHOISTEXT
    ...
    /// \copydoc Erebot::Interfaces::Numerics::RPL_RWHOREPLY
    ...
    /// \copydoc Erebot::Interfaces::Numerics::ERR_NOCTRLSONCHAN
    ...
    /// \copydoc Erebot::Interfaces::Numerics::ERR_MSGSERVICES
    const ERR_MSGSERVICES               = 487;

    /// \copydoc Erebot::Interfaces::Numerics::ERR_NOSSL
    const ERR_NOSSL                     = 488;

    /// \copydoc Erebot::Interfaces::Numerics::ERR_NOOPERHOST
    const ERR_NOOPERHOST                = 491;

    /// \copydoc Erebot::Interfaces::Numerics::ERR_NOSHAREDCHAN
    const ERR_NOSHAREDCHAN              = 493;

    /// \copydoc Erebot::Interfaces::Numerics::ERR_OWNMODE
