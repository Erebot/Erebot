...
/**
 * \brief
 *      Numeric profile for unknown IRC servers,
 *      based on RFC 2812.
 *
 * \note
 *      For compatibility reasons with the vast majority
 *      of IRCd implementations, <tt>RPL_BOUNCE</tt> has
 *      been replaced with <tt>RPL_ISUPPORT</tt> in this
 *      profile.
 */
class RFC2812 extends \Erebot\NumericProfile\Base
{
...
/*
    Left out as it conflicts with commonly supported RPL_ISUPPORT.
...
*/
    ...
    /// \copydoc Erebot::Interfaces::Numerics::RPL_TRACERECONNECT
    ...
    // Initially missing from RFC 2812; part of the errata.
    ...
    /// \copydoc Erebot::Interfaces::Numerics::ERR_UNIQOPPRIVSNEEDED
