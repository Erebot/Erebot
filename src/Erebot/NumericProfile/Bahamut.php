 ...
 */
class   Erebot_NumericProfile_Bahamut
extends Erebot_NumericProfile_Base
{
    ...
    /// \copydoc Erebot_Interface_Numerics::RPL_STATSCLONE.
    ...
    /// \copydoc Erebot_Interface_Numerics::RPL_WHOISTEXT.
    ...
    /// \copydoc Erebot_Interface_Numerics::RPL_RWHOREPLY.
    ...
    /// \copydoc Erebot_Interface_Numerics::ERR_NOCTRLSONCHAN.
    ...
    /// \copydoc Erebot_Interface_Numerics::ERR_MSGSERVICES.
    const ERR_MSGSERVICES               = 487;

    /// \copydoc Erebot_Interface_Numerics::ERR_NOSSL.
    const ERR_NOSSL                     = 488;

    /// \copydoc Erebot_Interface_Numerics::ERR_NOOPERHOST.
    const ERR_NOOPERHOST                = 491;

    /// \copydoc Erebot_Interface_Numerics::ERR_NOSHAREDCHAN.
    const ERR_NOSHAREDCHAN              = 493;

    /// \copydoc Erebot_Interface_Numerics::ERR_OWNMODE.
