 ...
 */
class   Erebot_NumericProfile_IrcdRatbox
extends Erebot_NumericProfile_Base
{
    ...
    /// \copydoc Erebot_Interface_Numerics::RPL_WHOISLOGGEDIN.
    ...
    /// \copydoc Erebot_Interface_Numerics::ERR_BANNEDNICK.
    ...
    /// \copydoc Erebot_Interface_Numerics::ERR_TARGCHANGE.
    ...
    /// \copydoc Erebot_Interface_Numerics::ERR_TARGUMODEG.
    ...
    /// \copydoc Erebot_Interface_Numerics::RPL_TESTMASKGECOS.
    const RPL_TESTMASKGECOS             = 727;

    /// \copydoc Erebot_Interface_Numerics::RPL_MONONLINE.
    const RPL_MONONLINE                 = 730;

    /// \copydoc Erebot_Interface_Numerics::RPL_MONOFFLINE.
    const RPL_MONOFFLINE                = 731;

    /// \copydoc Erebot_Interface_Numerics::RPL_MONLIST.
    const RPL_MONLIST                   = 732;

    /// \copydoc Erebot_Interface_Numerics::RPL_ENDOFMONLIST.
    const RPL_ENDOFMONLIST              = 733;

    /// \copydoc Erebot_Interface_Numerics::ERR_MONLISTFULL.
    const ERR_MONLISTFULL               = 734;

    /// \copydoc Erebot_Interface_Numerics::RPL_RSACHALLENGE2.
    const RPL_RSACHALLENGE2             = 740;

    /// \copydoc Erebot_Interface_Numerics::RPL_ENDOFRSACHALLENGE2.
