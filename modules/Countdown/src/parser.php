<?php
/* Driver template for the PHP_CountdownParser_rGenerator parser generator. (PHP port of LEMON)
*/
 ...
 */
class CountdownParser_yyToken implements ArrayAccess
{
    public $string = '';
    ...
    {
        if ($s instanceof CountdownParser_yyToken) {
            $this->string = $s->string;
            $this->metadata = $s->metadata;
        } else {
            $this->string = (string) $s;
            if ($m instanceof CountdownParser_yyToken) {
    ...
    function offsetSet($offset, $value)
    {
        if ($offset === null) {
            if (isset($value[0])) {
                $x = ($value instanceof CountdownParser_yyToken) ?
        ...
        if ($value instanceof CountdownParser_yyToken) {
            if ($value->metadata) {
 ...
 */
class CountdownParser_yyStackEntry
{
...
#line 2 "parser.y"
class CountdownParser#line 102 "parser.php"
{
...
static public $yy_action = array(
 /*     0 */     4,    5,    1,    2,    6,   10,   13,    4,    5,    1,
 /*    10 */     2,   22,    7,    3,    8,   11,   20,    1,    2,    9,
 /*    20 */    12,
    );
    static public $yy_lookahead = array(
 /*     0 */     1,    2,    3,    4,   10,    6,   10,    1,    2,    3,
 /*    10 */     4,    9,   10,    5,   10,    7,   11,    3,    4,   10,
 /*    20 */    10,
);
    const YY_SHIFT_USE_DFLT = -2;
    const YY_SHIFT_MAX = 9;
    static public $yy_shift_ofst = array(
 /*     0 */     8,    8,    8,    8,    8,    8,   -1,    6,   14,   14,
);
 ...
 /*     0 */    21,   21,   21,   21,   21,   21,   21,   14,   16,   17,
 /*    10 */    15,   20,   19,   18,
);
...
*/
  ...
  'OP_DIV',        'PAR_OPEN',      'PAR_CLOSE',     'INTEGER',     
  'error',         'formula',       'expr',        
    );
 ...
 /*   4 */ "expr ::= expr OP_MUL expr",
 /*   5 */ "expr ::= expr OP_DIV expr",
 /*   6 */ "expr ::= INTEGER",
    );
     ...
     * @param CountdownParser_yyParser
     * @return int
     */
            ...
            if ($yyact >= self::YYNSTATE && $yyact < self::YYNSTATE + self::YYNRULE) {
                ...
                do {
                    ...
                    if ($nextstate < self::YYNSTATE) {
                        ...
                        $this->yyidx++;
                        $x = new CountdownParser_yyStackEntry;
                        $x->stateno = $nextstate;
    ...
    function yy_shift($yyNewState, $yyMajor, $yypMinor)
    {
        ...
        $yytos = new CountdownParser_yyStackEntry;
...
#line 766 "parser.php"
    ...
    function yy_reduce($yyruleno)
    {
        ...
        //CountdownParser_yyStackEntry $yymsp;            /* The top of the parser's stack */
    ...
    {
#line 3 "parser.y"
 throw new ECountdownSyntaxError(); #line 880 "parser.php"
    }
